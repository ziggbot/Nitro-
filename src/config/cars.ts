...
export const CAR_CLASSES: CarClassDef[] = [
  {
    ...
    unlockLevel: 1,
    base: { topSpeed: 340, accel: 420, traction: 0.16, turnRate: 4.0, tank: 100, armor: 2 },
    texture: 'car-sports',
  },
  {
    id: 'racer',
    ...
    unlockLevel: 4,
    base: { topSpeed: 400, accel: 500, traction: 0.12, turnRate: 3.6, tank: 85, armor: 1 },
    texture: 'car-racer',
  },
  {
    id: 'buggy',
    ...
    unlockLevel: 7,
    base: { topSpeed: 310, accel: 380, traction: 0.22, turnRate: 4.5, tank: 115, armor: 3 },
    texture: 'car-buggy',
  },
];
